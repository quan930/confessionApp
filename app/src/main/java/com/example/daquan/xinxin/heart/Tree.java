package com.example.daquan.xinxin.heart;
...
//        canvas.drawColor(0xffffffee);
    ...
    private final void drawSnapshot(final Canvas canvas) {
        canvas.drawBitmap(treeSnapshot.bitmap,0,0, snapshotPaint);//树
    }
    ...
    private void drawFallingBlooms(Canvas canvas) {
        ...
        canvas.save();
        canvas.translate(bloomsDx, bloomsDy);//花花花花
        while (iterator.hasNext()) {
